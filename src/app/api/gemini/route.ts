...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      {
        data: `[{"text": "I cannot answer this. Please consult a licensed doctor for more information.","action": "Consult a licensed doctor for more information.","action_link": "${await getFirstResultLink(
          "doctors near me",
        )}","action_tag":"medical"}]`,
      },
      { status: 201 },
